    ...
    public List<Article> scrape(String url) {
        ...
        try {
            ...
            for (Element newsItem : newsItems) {
                ...
                try {
                    if (urlNews.startsWith("/"))
                        urlNews = "https://20minutos.es".concat(urlNews);
                    else
                        continue;
                    ...
                    Element publicationDate = newsDoc.selectFirst("time");
                    ...
                    log.error("[VeinteMinutosScraper] -> Error al obtener el detalle de la noticia: {}", urlNews, e);
                }
            }
        } catch (Exception e) {
